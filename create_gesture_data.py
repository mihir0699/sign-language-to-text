...
def segment_hand(frame, threshold=25):
    ...
    contours,_ = cv2.findContours(thresholded.copy(), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)#, hierarchy
    ...
    if num_frames < 60:
        ...
        if hand is not None:
            ...
            if num_imgs_taken <= 300:
                cv2.imwrite(r"train\\"+str(element)+"\\" + str(num_imgs_taken+300) + '.jpg', thresholded)
